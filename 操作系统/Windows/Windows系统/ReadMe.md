...
方法二：按下 `win + R` 打开运行窗口，输入 `cmd`，然后按 `Ctrl + Shift + Enter` 。
...
![image-20230320102733136](ReadMe.assets/image-20230320102733136.png)
...
![image-20230320103106132](ReadMe.assets/image-20230320103106132.png)
